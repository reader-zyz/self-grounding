...
class Tool_Frame():
    ...
    def Get_Tool_Envelope(self, tool_name) -> Tuple[int, dict]:
        """
        获取指定工具坐标系的包络参数
...
class Move_Plan():
    ...
    def Movej_CANFD(self, joint, follow, expand=0):
        ...
        logger_.info(f'Movej_CANFD:{tag}')
    ...
    def Movep_CANFD(self, pose, follow):
        ...
        logger_.info(f'Movep_CANFD:{tag}')
...
class Algo:
    ...
    def Algo_Inverse_Kinematics(cls, q_in, q_pose, flag):
        ...
        q_out = (ctypes.c_float * 6)()
        q_in = (ctypes.c_float * 6)(*q_in)
        ...
        cls.pDll.Algo_Inverse_Kinematics.argtypes = (
            ctypes.c_float * 6, ctypes.POINTER(Pose), ctypes.c_float * 6, ctypes.c_uint8)
